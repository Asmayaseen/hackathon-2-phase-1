    ...
    <div className="min-h-screen bg-background relative overflow-hidden transition-colors duration-300">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            >
              ...
              <div className="relative px-6 py-3 bg-gradient-to-r from-cyan-500 to-fuchsia-500 rounded-xl text-foreground font-bold uppercase text-sm tracking-wider border border-cyan-400/30 shadow-[0_0_30px_rgba(0,217,255,0.4)]">
                Initialize
              </div>
            </Link>
          </div>
      ...
      <section id="features" className="container mx-auto px-6 py-20 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {/* Feature 1 */}
          <div className="group relative bg-card/80 backdrop-blur-sm p-8 rounded-2xl transition-all duration-500 border-2 border-cyan-500/30 hover:border-cyan-400 hover:shadow-[0_0_40px_rgba(0,217,255,0.3)]">
          ...
          {/* Feature 2 */}
          <div className="group relative bg-card/80 backdrop-blur-sm p-8 rounded-2xl transition-all duration-500 border-2 border-fuchsia-500/30 hover:border-fuchsia-400 hover:shadow-[0_0_40px_rgba(236,72,153,0.3)]">
            <div className="relative">
      ...
      <section className="container mx-auto px-6 py-20 relative z-10">
        <div className="relative bg-gradient-to-r from-cyan-600 via-fuchsia-600 to-purple-600 rounded-3xl p-12 md:p-16 text-center shadow-2xl shadow-cyan-500/20">
          ...
          <div className="relative">
            ...
            <Link
              href="/signup"
              className="inline-block px-10 py-4 bg-white text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-purple-600 rounded-xl font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-200 border-2 border-white"
            >
